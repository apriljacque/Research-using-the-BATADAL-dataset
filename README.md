...
This folder contains the datasets used to evaluate the proposed Blockchain Verification Anomaly Detection Framework, that combines blockchain verification with unsupervised machine learning for anomaly detection in Industrial Control Systems (ICS) and Supervisory Control and Data Acquisition (SCADA) systems.
